...
To remedy this, I've created a plugin to make Obsidian my single source of truth, where all forms of learning content will react and change with my notes as I create them, rather than being an afterthought.
